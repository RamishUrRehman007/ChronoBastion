...
from exceptions import ChronoBastionAppError
from libs import log_sanitizer
from views import status_view, date_time_view
...
def include_routers(app: FastAPI) -> None:
    ...
    app.include_router(date_time_view.router, prefix="/v1")


def add_exception_handlers(app: FastAPI) -> None:
    app.add_exception_handler(ChronoBastionAppError, exception_handler)
